...
app.loader.add("player", "./image/bart.png");

let sky = create_sprite('./image/Sky.png');
let buildings = create_sprite('buildings.png');
let graph = create_sprite('./image/wall_graph.png');
let road = create_sprite('./image/road.png');
let spead = window.innerWidth / 150;
let player;
let obstacle = create_obstacle('./image/pigeon.png');
